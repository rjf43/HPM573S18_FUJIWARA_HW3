class Node:
    """ base class """
    def __init__(self, name, cost, healthutility):
        """

        :param name: name of the node
        :param cost: cost of the node
        :param healthutility: health utility of the node
        """
        self.name = name
        self.cost = cost
        self.healthutility = healthutility
    ...
    def get_expected_utility(self):
        """abstract method to be overridden in derived classes
        will return expected utility of this node"""
        raise NotImplementedError("This is an abstract method and will be implemented in derived classes.")

class ChanceNode(Node):

    def __init__(self, name, cost, healthutility, future_nodes, probs):
        """
        :param future_nodes: future nodes connected to this node
        :param probs: probability of the future nodes
        """
        Node.__init__(self, name, cost, healthutility)
    ...
    def get_expected_utility(self):
        ...
        """
        exp_utility = self.healthutility
        i = 0
        for node in self.futureNodes:
...
class DecisionNode(Node):
    ...
    def __init__(self, name, cost, healthutility, future_nodes):
        Node.__init__(self, name, cost, healthutility)
    ...
    def get_expected_utility(self):
        """ returns expected health utility of future nodes"""
        utilities = dict()
        for node in self.futureNode:
            utilities[node.name] = node.get_expected_utility()
